...
class testRealEmail_traffic(unittest.TestCase):
    ...
    def test_ids(self):
        """
        Verify that items retrieved by message_id have correct Message-ID.
        """
    ...
    def test_dates(self):
        """
        Verify that retrieving recordsbetween the minimum and maximum dates
        returns an appropiate number of records.
        """
        ...
        self.assertEqual(self.rowcount, 
                         len(maildb.msgs(mindate=mindate, maxdate=maxdate)))
